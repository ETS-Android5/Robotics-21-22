...
class FourWheelRobot(val hardwareMap: HardwareMap) {
    ...
    val rightFront = getWheel("rightFront", DcMotorSimple.Direction.REVERSE)
    val leftRear = getWheel("leftRear", DcMotorSimple.Direction.REVERSE)
    val rightRear = getWheel("rightRear", DcMotorSimple.Direction.REVERSE)
